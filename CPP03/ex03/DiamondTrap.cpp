...
/*   Updated: 2021/11/03 17:31:23 by aisraely         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
DiamondTrap::DiamondTrap(const DiamondTrap &copy) : ClapTrap(copy._name + "_clap_name"), FragTrap(copy._name + "_clap_name"), ScavTrap(copy._name + "_clap_name"), _name(copy._name)
{
